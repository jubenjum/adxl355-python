...
class ADXL355:
    ...
    def __init__(self, measure_range=RANGE_2G):
        ...
        self.i2c.open(i2c_BUS, i2c_DEVICE)
        self.i2c.max_speed_hz = i2c_MAX_CLOCK_HZ
        self.i2c.mode = i2c_MODE
    ...
    def write_data(self, address, value):
        ...
        self.i2c.xfer2([device_address, value])
    ...
    def read_data(self, address):
        ...
        return self.i2c.xfer2([device_address, DUMMY_BYTE])[1]
    ...
    def read_multiple_data(self, address_list):
        ...
        for address in address_list:
            i2c_ops.append(address << 1 | READ_BIT)
        i2c_ops.append(DUMMY_BYTE)

        return self.i2c.xfer2(i2c_ops)[1:]
